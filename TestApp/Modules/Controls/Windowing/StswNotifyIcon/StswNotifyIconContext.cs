...
public class StswNotifyIconContext : ControlsContext
{
    ...
    public StswAsyncCommand ShowTipCommand => new(ShowTip);
    ...
    private async Task ShowTipMinimized()
    {
        ...
        {
            TipTitle = "Lorem ipsum dolor sit amet...",
            ...
            TipIcon = (StswNotificationType)new Random().Next(4)
        });
    }
    ...
    private async Task ShowTip()
    {
        await StswNotifyIcon.Notify(
            ...
            (StswNotificationType)new Random().Next(4));
    }
    #endregion
