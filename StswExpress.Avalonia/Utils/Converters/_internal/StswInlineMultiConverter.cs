...
internal class StswInlineMultiConverter(StswInlineMultiConverter.ConvertDelegate convert, StswInlineMultiConverter.ConvertBackDelegate? convertBack = null) : IMultiValueConverter
{
    ...
    public delegate object ConvertDelegate(IList<object?> values, Type targetType, object? parameter, CultureInfo culture);
    ...
    /// <param name="culture">The culture to use in the converter.</param>
    /// <returns>A converted value.</returns>
    public object? Convert(IList<object?> values, Type targetType, object? parameter, CultureInfo culture) => _convert(values, targetType, parameter, culture);
