...
public class StswInvertConverter : MarkupExtension, IValueConverter
{
    ...
    /// <returns>The inverted value, or <see cref="BindingOperations.DoNothing"/> if the type is unsupported.</returns>
    ...
    /// <summary>
    /// Inverts the elements of a list.
    /// </summary>
    ...
    /// <summary>
    /// Inverts a numeric value by flipping its sign.
    /// </summary>
    /// <param name="value">The numeric value to invert.</param>
    /// <param name="typeCode">The type code of the numeric value.</param>
    /// <returns>The inverted numeric value, or <see cref="BindingOperations.DoNothing"/> if the type is unsupported.</returns>
