...
public partial class ControlsContext : StswObservableObject
{
    ...
    public virtual void SetDefaults()
    {
        try
        {
            var styleType = Type.GetType($"StswExpress.Avalonia.{ThisControlName}, StswExpress.Avalonia");
            if (styleType != null && Application.Current != null)
            {
                if (Application.Current.TryGetResource(styleType, null, out var styleObj) && styleObj is Style style)
