...
public class TrLanguageIdConverter : MarkupExtension, IValueConverter
{
    ...
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture) => $"{Prefix}{TM.Tr(TextID, DefaultText?.Replace("[apos]", "'"), value as string)}{Suffix}";
