...
/// </summary>
public class StswComponentRadio : RadioButton, IStswComponentControl, IStswIconControl
{
    static StswComponentRadio()
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(StswComponentRadio), new FrameworkPropertyMetadata(typeof(StswComponentRadio)));
    }
